# Decoding any word by AG codes to errors of weight the RGV bound 
...
def test(totalltests):
    ...
    for npair in range(totalltests):
        y = random_vector(Fqm,n)   # random word
        s = H*y 
...
#(q,m,n,t,k,r) = (2,30,41,30,19,12)  # Can decode weight r = 12
